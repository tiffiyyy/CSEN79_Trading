...
export function TransactionHistory({ title = "Transaction History", compact = false }: TransactionHistoryProps) {
            ...
            <table className="transaction-history-table">
              ...
              <tbody>
                {filtered.length === 0 ? (
                  ...
                  filtered.map((t) => <TransactionHistoryRow key={t.id} transaction={t} />)
                )}
              </tbody>
            </table>
          </div>
